...
namespace Organization
{
	...
	/// </summary>
	public class ParaCollection : CollectionBase, ICustomTypeDescriptor
	{
		...
		public PropertyDescriptorCollection GetProperties()
		{
			...
			for( int i=0; i<this.List.Count; i++ )
			{
				...
				ParaCollectionPropertyDescriptor pd = new ParaCollectionPropertyDescriptor(this,i);
				pds.Add(pd);
			}
